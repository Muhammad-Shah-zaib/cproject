...
Hotel find_least_expensive_hotel (Hotel *hotels, const unsigned int hotels_count, const unsigned int b_per_day, unsigned int choice){
    ...
    do {
        ...
        b_lowest_point -= b_offset_value;
         ...
         if (b_lowest_point < 0) {
            //  puts ("Not sufficient balance. Case 1.");
            //  exit (8);
            return NO_MATCH;
         }
    ...
    case 2:
        ...
        if (b_lowest_point < 0) {
            ...
            // puts ("Not sufficient balance Case 2.");
        //     exit (8);
            return NO_MATCH;
        }
...
case 3:
    do {
        ...
        if (b_lowest_point < 0) {
            // puts ("Not sufficient balance. Case 3");
            return NO_MATCH;
        //     exit (8);
        }
    ...
    // if (i == hotels_count) 
        // return NO_MATCH; // ! return null hotel if no match found
    return hotels[index];
}
}
